    ...
    <div class="p-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="orderId" class="block text-sm font-medium text-gray-700">주문 아이디</label>
                    <input 
                        id="orderId"
                ...
                <div>
                    <label for="orderDateFrom" class="block text-sm font-medium text-gray-700">주문일 (시작)</label>
                    <input 
                        id="orderDateFrom"
                ...
                <div>
                    <label for="orderDateTo" class="block text-sm font-medium text-gray-700">주문일 (종료)</label>
                    <input 
                        id="orderDateTo"
        ...
        <div v-else-if="error" class="bg-red-100 p-4 rounded text-red-700 mb-4">
            {{ error }}
            <button @click="searchOrders" class="ml-2 underline">다시 시도</button>
        </div>
